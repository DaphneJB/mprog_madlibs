 ...
 * com.example.jonkersbothdaphne_pset2.Story.java
 * Madlibs
 *
 ...
 * A com.example.jonkersbothdaphne_pset2.Story is Serializable, so it can be packed into an Intent as "extra" data.
 */
...
public class Story implements Serializable {
    ...
    /** constructs a new com.example.jonkersbothdaphne_pset2.Story reading its text from the given input stream */
